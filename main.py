...
st.text_area(
    "알게 된 점",
    value="영화의 인기가 개봉 후 시간이 지남에 따라 달라지는 것을 알 수 있다.",
    height=100,
    key="graph1_note"
)
...
st.text_area(
    "알게 된 점",
    value="영화 각각의 일관객 수가 가장 높았던 시점과 가장 낮았던 시점을 볼 수 있고, 개봉 시기가 비슷한 영화들끼리 비교할 때 보기 쉽다는 것을 알 수 있다.",
    height=120,
    key="graph2_note"
)
...
st.text_area(
    "알게 된 점",
    value="특별한 기념일이나 공휴일과 인접한 날들에 일관객 합계가 높다는 것을 알 수 있다.",
    height=100,
    key="graph3_note"
)
...
st.text_area(
    "알게 된 점",
    value="일관객 합계 수가 높은 영화일수록 10위권에 든 날의 수가 많은 것을 알 수 있다.",
    height=100,
    key="graph4_note"
)
...
st.text_area(
    "알게 된 점",
    value="평일보다는 주말에 영화관을 찾는 사람들이 많다는 것을 알 수 있고, 어느 달의 어느 요일에 관객들이 많이 몰려있는지 색의 진하기로 구분할 수 있다.",
    height=120,
    key="graph5_note"
)
